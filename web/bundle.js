...
// ../../../../.cache/deno/npm/registry.npmjs.org/sql.js-httpvfs/0.8.12/dist/index.js
var require_dist = __commonJS({
  "../../../../.cache/deno/npm/registry.npmjs.org/sql.js-httpvfs/0.8.12/dist/index.js"(exports, module) {
    !function(e, t) {
      ...
      return (() => {
        ...
        var e = {
          870: (e2, t2, n2) => {
            ...
            const r = Symbol("Comlink.proxy"), o = Symbol("Comlink.endpoint"), a = Symbol("Comlink.releaseProxy"), i = Symbol("Comlink.thrown"), s = (e3) => "object" == typeof e3 && null !== e3 || "function" == typeof e3, c = /* @__PURE__ */ new Map([
              [
                "proxy",
                {
                  canHandle: (e3) => s(e3) && e3[r],
                  serialize(e3) {
                  ...
                  deserialize: (e3) => (e3.start(), f(e3))
                }
              ],
              [
                "throw",
                {
                  canHandle: (e3) => s(e3) && i in e3,
                  serialize({ value: e3 }) {
                    let t3;
                    return t3 = e3 instanceof Error ? {
                      isError: true,
                      value: {
                        message: e3.message,
                        name: e3.name,
            ...
            function l(e3, t3 = self) {
              t3.addEventListener("message", function n3(r2) {
                ...
                const { id: o2, type: a2, path: s2 } = Object.assign({
                  path: []
                }, r2.data), c2 = (r2.data.argumentList || []).map(w);
                let f2;
                try {
                ...
                Promise.resolve(f2).catch((e4) => ({
                  value: e4,
                  [i]: 0
                })).then((e4) => {
                  const [r3, i2] = b(e4);
                  t3.postMessage(Object.assign(Object.assign({}, r3), {
                    id: o2
                  }), i2), 5 === a2 && (t3.removeEventListener("message", n3), u(t3));
                });
              }), t3.start && t3.start();
            }
            function u(e3) {
            ...
            function d(e3, t3 = [], n3 = function() {
              ...
              let r2 = false;
              const i2 = new Proxy(n3, {
                get(n4, o2) {
                  if (p(r2), o2 === a) return () => E(e3, {
                    type: 5,
                    path: t3.map((e4) => e4.toString())
                  }).then(() => {
                    u(e3), r2 = true;
                  });
                  if ("then" === o2) {
            ...
            function m(e3) {
              ...
              return [
                t3.map((e4) => e4[0]),
                (n3 = t3.map((e4) => e4[1]), Array.prototype.concat.apply([], n3))
              ];
              var n3;
            }
            ...
            function g(e3, t3 = self, n3 = "*") {
              return {
                postMessage: (t4, r2) => e3.postMessage(t4, n3, r2),
                addEventListener: t3.addEventListener.bind(t3),
                removeEventListener: t3.removeEventListener.bind(t3)
              };
            }
            function b(e3) {
            ...
            function E(e3, t3, n3) {
              return new Promise((r2) => {
                ...
                }), e3.start && e3.start(), e3.postMessage(Object.assign({
                  id: o2
                }, t3), n3);
              });
            }
          ...
          162: function(e2, t2, n2) {
            var r = this && this.__createBinding || (Object.create ? function(e3, t3, n3, r2) {
              void 0 === r2 && (r2 = n3), Object.defineProperty(e3, r2, {
                enumerable: true,
                get: function() {
                  return t3[n3];
                }
            ...
            async function s(e3) {
              if (e3.data && "eval" === e3.data.action) {
                ...
                try {
                  r2 = {
                    ok: await u(e3.data.request)
                  };
                } catch (t4) {
                  console.error("worker request error", e3.data.request, t4), r2 = {
                    err: String(t4)
                  };
                }
            ...
            async function u(e3) {
              if (console.log("dom vtable request", e3), "select" === e3.type) return [
            ...
            i.transferHandlers.set("WORKERSQLPROXIES", {
              ...
              deserialize: (e3) => (e3.start(), i.wrap(e3))
            }), t2.createDbWorker = async function(e3, t3, n3, r2 = 1 / 0) {
              const o2 = new Worker(t3), a2 = i.wrap(o2), c2 = await a2.SplitFileHttpDatabase(n3, e3, void 0, r2);
              return o2.addEventListener("message", s), {
                db: c2,
                worker: a2,
                configs: e3
              };
...
async function getWorker() {
  if (!workerPromise) {
    workerPromise = (async () => {
      ...
      const worker = await (0, import_npm_sql_js_httpvfs_0_8.createDbWorker)([
        {
          from: "inline",
          config: {
...
(async () => {
  try {
    const rows = await runQuery("SELECT COUNT(*) AS n FROM games;");
